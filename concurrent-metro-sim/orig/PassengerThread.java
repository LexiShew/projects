    ...
    public void run() {
        ...
        while (!passenger.arrived()) {
            ...
            if (passengerTrain != null) {
                ...
                try {
                    while (passenger.deboardingStation() != passengerTrain.currentStation()) {
                        // P.pl("    PassengerThread -- " + this.name() + " awaiting " + passengerTrain.toString()
                                // + "'s lock");
                        passengerTrain.trainArrived.await();
                    }
                    ...
                    throw new RuntimeException("Passenger Thread ");
                }
                ...
                passengerTrain.trainLock.unlock();
                ...
                try {
                    ...
                    throw new RuntimeException("Passenger Thread interrupted", e);
                } finally {
                    trainToBoard.trainLock.unlock();
                }
